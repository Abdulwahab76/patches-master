        ...
        <div className="flex justify-between items-center h-20">
          <Link to="/" className="flex items-center cursor-pointer">
            <span className="text-2xl font-black tracking-tighter">
              PATCH<span className="text-orange-600">MASTER</span>
          ...
          <div className="hidden lg:flex space-x-8 items-center">
            <Link
              to="/"
              className="text-sm font-bold text-slate-600 hover:text-orange-600 transition"
            >
              Home
            </Link>
            ...
            <div className="relative group">
              ...
              <div
                ...
                className={`absolute left-0 mt-2 w-56 bg-white border border-slate-100 rounded-2xl shadow-2xl py-2 transition-all duration-200 ${
                  isDropdownOpen
          ...
          <div className="flex items-center space-x-5">
            <button className="relative p-2 text-slate-600 hover:text-orange-600 transition">
              ...
              {cartCount > 0 && (
                <span
                  onClick={onCartClick}
                  className="absolute top-0 right-0 bg-orange-600 text-white text-[10px] font-black w-5 h-5 flex items-center justify-center rounded-full shadow-lg border-2 border-white"
                >
                  {cartCount}
                </span>
              )}
